...
const char* wifi_name = "Galaxy A6+"; // Your Wifi network name here
const char* wifi_pass = "qwerty123";    // Your Wifi network password here
    ...
    while (client.connected())
    {
      if (client.available())                    // if there is some client data available
      {
        ...
        if (c == '\n' && currentLineIsBlank)    // check for newline character, 
        {
          ...
          client.print("<a href=\"/?relayoff\"\"><button>ON</button></a>");
          client.print("<a href=\"/?relayon\"\"><button>OFF</button></a>");
